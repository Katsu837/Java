...
public class Shop
{
   ...
   public void add_pc()
   {
      ...
      pc.setName(sc.next());
      System.out.print("Введите количество оперативной памяти компьютера: ");
      pc.setRam(sc.nextInt());
      System.out.print("Введите название процессора компьютера: ");
      pc.setCpu(sc.next());
      System.out.print("Введите название видеокарты компьютера: ");
      pc.setGpu(sc.next());
      mas.add(pc);
      System.out.println("\n");
